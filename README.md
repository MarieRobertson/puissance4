Ce fichier `README.md` décrit brièvement le projet, les étapes pour l'installer et le lancer, ainsi que ses principales fonctionnalités et technologies utilisées.
